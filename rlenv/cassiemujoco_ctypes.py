...
cassie_sim_get_cassie_out = _libraries["./libcassiemujoco.so"].cassie_sim_get_cassie_out
cassie_sim_get_cassie_out.restype = cassie_out_t
cassie_sim_get_cassie_out.argtypes = [POINTER_T(struct_cassie_sim)]
...
cassie_reload_xml.argtypes = [POINTER_T(ctypes.c_char)]
cassie_sim_init = _libraries["./libcassiemujoco.so"].cassie_sim_init
cassie_sim_init.restype = POINTER_T(struct_cassie_sim)
cassie_sim_init.argtypes = [POINTER_T(ctypes.c_char), ctypes.c_bool]
...
delete_init_model = _libraries["./libcassiemujoco.so"].delete_init_model
delete_init_model.restype = None
delete_init_model.argtypes = []
...
cassie_sim_step_pd_without_estimation = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_step_pd_without_estimation
cassie_sim_step_pd_without_estimation.restype = None
cassie_sim_step_pd_without_estimation.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(struct_c__SA_cassie_out_t),
    POINTER_T(struct_c__SA_pd_in_t),
]
cassie_state_estimation = _libraries["./libcassiemujoco.so"].cassie_state_estimation
cassie_state_estimation.restype = None
cassie_state_estimation.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(struct_c__SA_state_out_t),
    POINTER_T(struct_c__SA_cassie_out_t),
]
...
cassie_sim_foot_forces_all = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_foot_forces_all
cassie_sim_foot_forces_all.restype = None
cassie_sim_foot_forces_all.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 24,
]
...
cassie_sim_body_velocities = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_body_velocities
cassie_sim_body_velocities.restype = None
cassie_sim_body_velocities.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 6,
...
cassie_sim_xpos.argtypes = [POINTER_T(struct_cassie_sim), POINTER_T(ctypes.c_char)]
cassie_sim_xquat = _libraries["./libcassiemujoco.so"].cassie_sim_xquat
cassie_sim_xquat.restype = POINTER_T(ctypes.c_double)
cassie_sim_xquat.argtypes = [POINTER_T(struct_cassie_sim), POINTER_T(ctypes.c_char)]
...
cassie_sim_dof_stiffness = _libraries["./libcassiemujoco.so"].cassie_sim_dof_stiffness
cassie_sim_dof_stiffness.restype = POINTER_T(ctypes.c_double)
cassie_sim_dof_stiffness.argtypes = [POINTER_T(struct_cassie_sim)]
...
cassie_sim_body_inertia = _libraries["./libcassiemujoco.so"].cassie_sim_body_inertia
cassie_sim_body_inertia.restype = POINTER_T(ctypes.c_double)
cassie_sim_body_inertia.argtypes = [POINTER_T(struct_cassie_sim)]
...
cassie_sim_timestep.restype = ctypes.c_double
cassie_sim_timestep.argtypes = [POINTER_T(struct_cassie_sim)]
cassie_sim_setctrl = _libraries["./libcassiemujoco.so"].cassie_sim_setctrl
cassie_sim_setctrl.restype = None
cassie_sim_setctrl.argtypes = [POINTER_T(struct_cassie_sim), POINTER_T(ctypes.c_double)]
...
cassie_sim_set_dof_stiffness = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_dof_stiffness
cassie_sim_set_dof_stiffness.restype = None
cassie_sim_set_dof_stiffness.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_set_body_inertia = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_body_inertia
cassie_sim_set_body_inertia.restype = None
cassie_sim_set_body_inertia.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]
cassie_sim_foot_orient = _libraries["./libcassiemujoco.so"].cassie_sim_foot_orient
cassie_sim_foot_orient.restype = None
cassie_sim_foot_orient.argtypes = [POINTER_T(struct_cassie_sim), ctypes.c_double * 4]
...
cassie_sim_geom_name_pos.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_char),
]
...
cassie_sim_get_body_name_pos.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_char),
]
...
cassie_sim_get_drive_filter = _libraries[
    "./libcassiemujoco.so"
...
cassie_vis_slowmo = _libraries["./libcassiemujoco.so"].cassie_vis_slowmo
cassie_vis_slowmo.restype = ctypes.c_bool
cassie_vis_slowmo.argtypes = [POINTER_T(struct_cassie_vis)]
...
cassie_vis_remove_marker.argtypes = [POINTER_T(struct_cassie_vis), ctypes.c_int32]
...
__all__ = [
    ...
    "cassie_sim_dof_stiffness",
    "cassie_sim_duplicate",
    "cassie_sim_foot_forces",
    "cassie_sim_foot_forces_all",
    "cassie_sim_foot_orient",
